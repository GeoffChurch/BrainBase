...
# This is the full C Elegans Connectome as expresed in the form of the Presynaptic
...
def motorcontrol():
        ...
        #ADDED:
        set_speed(accumleft,accumright)
        #TODO new_speed = abs(accumleft) + abs(accumright)
        #TODO if new_speed > 150:
        #TODO         new_speed = 150
        #TODO elif new_speed < 75:
        #TODO         new_speed = 75
        print "Left: ", accumleft, "Right:", accumright#TODO , "Speed: ", new_speed
        ## Start Commented section
        #TODO set_speed(new_speed)
        #TODO if accumleft == 0 and accumright == 0:
        #TODO         stop()
        #TODO elif accumright <= 0 and accumleft < 0:
        #TODO         set_speed(150)
        #TODO         turnratio = float(accumright) / float(accumleft)
        #TODO         # print "Turn Ratio: ", turnratio
        #TODO         if turnratio <= 0.6:
        #TODO                  left_rot()
        #TODO                  time.sleep(0.8)
        #TODO         elif turnratio >= 2:
        #TODO                  right_rot()
        #TODO                  time.sleep(0.8)
        #TODO         bwd()
        #TODO         time.sleep(0.5)
        ...
        accumleft = 0
        accumright = 0
        time.sleep(0.5) #TODO maybe lower?
...
createpostsynaptic()
print "postsynaptic size: ", len(postsynaptic)
dist=0
#TODO set_speed(120)
#TODO print "Voltage: ", volt()
tfood = 0
try:
